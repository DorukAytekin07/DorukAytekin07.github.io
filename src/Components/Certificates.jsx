...
import RC from "../../src/assets/img/certificates/React Certificate.webp"
import FEDC from "../../src/assets/img/certificates/Front-End-Development-Certificate.webp"
        ...
        return(
            <section>
                ...
                <div className="certificates">
                    ...
                    <img className="certificate" src={RC} alt="" />
                    <img className="certificate" src={SQL} alt="" />
                    <img className="certificate" src={RWD} alt="" />
                    {/* <img className="certificate" src={FEDC} alt="" /> */}
